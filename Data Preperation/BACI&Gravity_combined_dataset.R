...
library(plyr)
library(ff)
setwd("C:/Users/sandr/Desktop/SNA/Social-Network-Analysis-NAFTA/")

gravity1995_1999_agg<-read.csv("C:/Users/sandr/Desktop/SNA/Social-Network-Analysis-NAFTA/gravity1995_1999_agg.csv")
gravity2000_2004_agg<-read.csv("C:/Users/sandr/Desktop/SNA/Social-Network-Analysis-NAFTA/gravity2000_2004_agg.csv")
gravity2005_2009_agg<-read.csv("C:/Users/sandr/Desktop/SNA/Social-Network-Analysis-NAFTA/gravity2005_2009_agg.csv")
gravity2010_2014_agg<-read.csv("C:/Users/sandr/Desktop/SNA/Social-Network-Analysis-NAFTA/gravity2010_2014_agg.csv")
gravity2015_2017_agg<-read.csv("C:/Users/sandr/Desktop/SNA/Social-Network-Analysis-NAFTA/gravity2015_2017_agg.csv")

BACI95_99_agg<-read.csv("C:/Users/sandr/Desktop/SNA/Social-Network-Analysis-NAFTA/BACI95_99_agg.csv")
...
write.csv(BACI_Grav_95_99, file = "BACI_Grav_95_99.csv")
...
write.csv(BACI_Grav_00_04, file = "BACI_Grav_00_04.csv")
...
write.csv(BACI_Grav_05_09, file = "BACI_Grav_05_09.csv")
...
write.csv(BACI_Grav_10_14, file = "BACI_Grav_10_14.csv")
...
write.csv(BACI_Grav_15_17, file = "BACI_Grav_15_17.csv")
